...
> If an update is missing, please contact me via **Discord: `t_gow`**.
...
You may need to adjust:
    ...
    Drop campaign identifiers

    Streamer or category selection
...
This project is licensed under a MIT-based license with a mandatory credit requirement.
...
You are allowed to:
    ...
    Upload versions for other Twitch Drops or games

Credits to the original author are required.
